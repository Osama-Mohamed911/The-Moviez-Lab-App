        ...
        <div className="container">
              ...
              <div className="col-lg-4">
                <form className="d-flex " role="search">
                  <input
                    ...
                    type="search"
                    placeholder="Get Movies By Word..."
                    aria-label="Search"
                  />
                </form>
              </div>
          ...
          <div className="row">
            {movies.length >= 1 ? (
              ...
              <div className="py-5">
                <i class="fa-solid fa-magnifying-glass d-block text-center text-white fs-5"></i>
